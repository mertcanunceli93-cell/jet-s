...
export default function CorporateDashboard() {
  ...
  const stats = [
    { title: 'Aktif Siparişler', value: '12', icon: Package, color: 'text-brand-orange' },
    { title: 'Aylık Harcama', value: '₺45,000', icon: TrendingUp, color: 'text-green-500' },
    { title: 'Alt Kullanıcılar', value: '8', icon: Users, color: 'text-blue-500' },
    { title: 'Şube Sayısı', value: '3', icon: Building2, color: 'text-purple-500' },
  ];
