            ...
            <AnimatePresence mode="wait">
              {activeTab === 'profile' && (
                ...
                >
                  ...
                  <div className="pt-6">
                    <button className="px-8 py-4 bg-gradient-to-r from-brand-orange to-[#ff9d42] text-white rounded-2xl font-black hover:shadow-[0_0_30px_rgba(255,122,0,0.5)] transition-all flex items-center gap-3">
